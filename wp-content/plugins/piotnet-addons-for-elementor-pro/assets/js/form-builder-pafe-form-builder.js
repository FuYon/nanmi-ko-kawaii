					...
					if ($dateField.length > 0 && !checkIsMobile()) {
						var addDatePicker = function addDatePicker($element) {
                            ...
                            if ($element.hasClass('flatpickr-custom-options')) {
                                if (isValidJSONString($element.attr('data-flatpickr-custom-options'))) {
                                   options = JSON.parse($element.attr('data-flatpickr-custom-options'));
                                } else {
                                   options = $element.attr('data-flatpickr-custom-options');
                                }
                            }
